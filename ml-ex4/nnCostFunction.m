...
% Tranform y = {1,2,3...} to a vectors  [1;0;0] or [0;1;0] or [0;0;1] ...
...
h = sigmoid(Theta2 * a2);		% 10 x m

cost = Y .* log(h) + (1-Y) .* log(1-h); 	% Get cost

J = -(1/m) * sum(sum(cost));	

%% PART 2 - Backpropagation
delta3 = h - Y; 	% 10 x m
delta2 = (Theta2' * delta3) .* [ones(1,m); sigmoidGradient(z2)]; 	%m x 26
